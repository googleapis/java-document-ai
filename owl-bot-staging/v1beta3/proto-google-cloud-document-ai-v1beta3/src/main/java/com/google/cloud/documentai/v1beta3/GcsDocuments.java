        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              documents_ = new java.util.ArrayList<com.google.cloud.documentai.v1beta3.GcsDocument>();
              mutable_bitField0_ |= 0x00000001;
            }
            documents_.add(
                input.readMessage(com.google.cloud.documentai.v1beta3.GcsDocument.parser(), extensionRegistry));
            break;
          }
          default: {
