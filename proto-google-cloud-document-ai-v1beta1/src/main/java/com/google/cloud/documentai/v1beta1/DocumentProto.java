  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "cloud/documentai/v1beta1/geometry.proto\032\027google/rpc/status.proto\032\027google/type/color.proto\"\372$\n"
          + "\010Document\022\r\n"
          ...
          + " \003(\0132/.google.cloud.documentai.v1beta1.Document.Style\022=\n"
          + "\005pages\030\006 \003(\0132..google.cloud.documentai.v1beta1.Document.Page\022B\n"
          + "\010entities\030\007"
          + " \003(\01320.google.cloud.documentai.v1beta1.Document.Entity\022R\n"
          + "\020entity_relations\030\010"
          + " \003(\01328.google.cloud.documentai.v1beta1.Document.EntityRelation\022G\n\n"
          ...
          + " \001(\01324.google.cloud.documentai.v1beta1.Document.TextAnchor\022!\n"
          ...
          + "\tfont_size\030\007"
          + " \001(\01328.google.cloud.documentai.v1beta1.Document.Style.FontSize\032&\n"
          + "\010FontSize\022\014\n"
          ...
          + "\tdimension\030\002"
          + " \001(\01328.google.cloud.documentai.v1beta1.Document.Page.Dimension\022E\n"
          + "\006layout\030\003"
          + " \001(\01325.google.cloud.documentai.v1beta1.Document.Page.Layout\022[\n"
          + "\022detected_languages\030\004"
          + " \003(\0132?.google.cloud.documentai.v1beta1.Document.Page.DetectedLanguage\022D\n"
          + "\006blocks\030\005"
          + " \003(\01324.google.cloud.documentai.v1beta1.Document.Page.Block\022L\n\n"
          + "paragraphs\030\006"
          + " \003(\01328.google.cloud.documentai.v1beta1.Document.Page.Paragraph\022B\n"
          + "\005lines\030\007"
          + " \003(\01323.google.cloud.documentai.v1beta1.Document.Page.Line\022D\n"
          + "\006tokens\030\010"
          + " \003(\01324.google.cloud.documentai.v1beta1.Document.Page.Token\022U\n"
          + "\017visual_elements\030\t"
          + " \003(\0132<.google.cloud.documentai.v1beta1.Document.Page.VisualElement\022D\n"
          + "\006tables\030\n"
          + " \003(\01324.google.cloud.documentai.v1beta1.Document.Page.Table\022M\n"
          + "\013form_fields\030\013"
          + " \003(\01328.google.cloud.documentai.v1beta1.Document.Page.FormField\0328\n"
          + "\tDimension\022\r\n"
          ...
          + "\006Layout\022I\n"
          + "\013text_anchor\030\001"
          + " \001(\01324.google.cloud.documentai.v1beta1.Document.TextAnchor\022\022\n\n"
          + "confidence\030\002 \001(\002\022D\n\r"
          + "bounding_poly\030\003 \001(\0132-.google.cloud.documentai.v1beta1.BoundingPoly\022V\n"
          + "\013orientation\030\004"
          + " \001(\0162A.google.cloud.documentai.v1beta1.Document.Page.Layout.Orientation\"e\n"
          ...
          + " \003(\0132?.google.cloud.documentai.v1beta1.Document.Page.DetectedLanguage\032\257\001\n"
          + "\tParagraph\022E\n"
          + "\006layout\030\001"
          + " \001(\01325.google.cloud.documentai.v1beta1.Document.Page.Layout\022[\n"
          + "\022detected_languages\030\002"
          + " \003(\0132?.google.cloud.documentai.v1beta1.Document.Page.DetectedLanguage\032\252\001\n"
          + "\004Line\022E\n"
          + "\006layout\030\001"
          + " \001(\01325.google.cloud.documentai.v1beta1.Document.Page.Layout\022[\n"
          + "\022detected_languages\030\002"
          + " \003(\0132?.google.cloud.documentai.v1beta1.Document.Page.DetectedLanguage\032\265\003\n"
          + "\005Token\022E\n"
          + "\006layout\030\001"
          + " \001(\01325.google.cloud.documentai.v1beta1.Document.Page.Layout\022Z\n"
          + "\016detected_break\030\002"
          + " \001(\0132B.google.cloud.documentai.v1beta1.Document.Page.Token.DetectedBreak\022[\n"
          + "\022detected_languages\030\003"
          + " \003(\0132?.google.cloud.documentai.v1beta1.Document.Page.DetectedLanguage\032\253\001\n"
          + "\r"
          + "DetectedBreak\022U\n"
          + "\004type\030\001"
          + " \001(\0162G.google.cloud.documentai.v1beta1.Document.Page.Token.DetectedBreak.Type\"C\n"
          + "\004Type\022\024\n"
          ...
          + "VisualElement\022E\n"
          + "\006layout\030\001"
          + " \001(\01325.google.cloud.documentai.v1beta1.Document.Page.Layout\022\014\n"
          + "\004type\030\002 \001(\t\022[\n"
          + "\022detected_languages\030\003"
          + " \003(\0132?.google.cloud.documentai.v1beta1.Document.Page.DetectedLanguage\032\202\005\n"
          + "\005Table\022E\n"
          + "\006layout\030\001"
          + " \001(\01325.google.cloud.documentai.v1beta1.Document.Page.Layout\022R\n"
          + "\013header_rows\030\002"
          + " \003(\0132=.google.cloud.documentai.v1beta1.Document.Page.Table.TableRow\022P\n"
          + "\tbody_rows\030\003"
          + " \003(\0132=.google.cloud.documentai.v1beta1.Document.Page.Table.TableRow\022[\n"
          + "\022detected_languages\030\004"
          + " \003(\0132?.google.cloud.documentai.v1beta1.Document.Page.DetectedLanguage\032Y\n"
          + "\010TableRow\022M\n"
          + "\005cells\030\001"
          + " \003(\0132>.google.cloud.documentai.v1beta1.Document.Page.Table.TableCell\032\323\001\n"
          + "\tTableCell\022E\n"
          + "\006layout\030\001"
          + " \001(\01325.google.cloud.documentai.v1beta1.Document.Page.Layout\022\020\n"
          + "\010row_span\030\002 \001(\005\022\020\n"
          + "\010col_span\030\003 \001(\005\022[\n"
          + "\022detected_languages\030\004"
          + " \003(\0132?.google.cloud.documentai.v1beta1.Document.Page.DetectedLanguage\032\347\002\n"
          + "\tFormField\022I\n\n"
          + "field_name\030\001"
          + " \001(\01325.google.cloud.documentai.v1beta1.Document.Page.Layout\022J\n"
          + "\013field_value\030\002"
          + " \001(\01325.google.cloud.documentai.v1beta1.Document.Page.Layout\022`\n"
          + "\027name_detected_languages\030\003"
          + " \003(\0132?.google.cloud.documentai.v1beta1.Document.Page.DetectedLanguage\022a\n"
          + "\030value_detected_languages\030\004"
          + " \003(\0132?.google.cloud.documentai.v1beta1.Document.Page.DetectedLanguage\032=\n"
          + "\020DetectedLanguage\022\025\n\r"
          + "language_code\030\001 \001(\t\022\022\n\n"
          + "confidence\030\002 \001(\002\032\213\001\n"
          + "\006Entity\022I\n"
          + "\013text_anchor\030\001"
          + " \001(\01324.google.cloud.documentai.v1beta1.Document.TextAnchor\022\014\n"
          ...
          + " \003(\0132@.google.cloud.documentai.v1beta1.Document.TextAnchor.TextSegment\0325\n"
          + "\013TextSegment\022\023\n"
          + "\013start_index\030\001 \001(\003\022\021\n"
          + "\tend_index\030\002 \001(\003B\010\n"
          + "\006sourceB\352\001\n"
          + "#com.google.cloud.documentai.v1beta1B\r"
          + "DocumentProtoP\001ZIgoogle.golang.org/genproto/googleapis/c"
          + "loud/documentai/v1beta1;documentai\252\002\037Goo"
          + "gle.Cloud.DocumentAI.V1Beta1\312\002\037Google\\Cl"
          + "oud\\DocumentAI\\V1beta1\352\002\"Google::Cloud::DocumentAI::V1beta1b\006proto3"
    };
    descriptor =
