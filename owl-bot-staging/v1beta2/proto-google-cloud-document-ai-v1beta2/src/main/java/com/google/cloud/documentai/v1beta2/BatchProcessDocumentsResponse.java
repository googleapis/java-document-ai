        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              responses_ = new java.util.ArrayList<com.google.cloud.documentai.v1beta2.ProcessDocumentResponse>();
              mutable_bitField0_ |= 0x00000001;
            }
            responses_.add(
                input.readMessage(com.google.cloud.documentai.v1beta2.ProcessDocumentResponse.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.documentai.v1beta2.BatchProcessDocumentsResponse) e.getUnfinishedMessage();
